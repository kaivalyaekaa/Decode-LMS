...
exports.createRegistration = async (req, res) => {
    try {
        const { fullName, email, phone, cityCountry, programLevel, referralSource, referrerName, mode, region } = req.body;
...
exports.studentLogin = async (req, res) => {
    try {
        ...
        const registration = await Registration.findOne({ email, phone }).select('fullName email phone programLevel mode paymentStatus certificateStatus batchId');
